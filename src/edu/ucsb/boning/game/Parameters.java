...
public class Parameters {
    ...
    public static final double MAX_AGE_SHEEP = 10;
    public static final double MAX_AGE_WOLF = 20;
    ...
    public static final double FOOD_EAT_VALUE_WOLF = 35;
    ...
    public static final double SEX_INCREASE_RATE_WOLF = 20;
    public static final double PREGNENT_PROBABILITY_SHEEP = 0.8;
    public static final double PREGNENT_PROBABILITY_WOLF = 0.6;
